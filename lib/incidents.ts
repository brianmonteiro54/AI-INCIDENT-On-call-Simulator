...
export const INCIDENTS: Incident[] = [
  ...
  // SEV-2: Comprehend sentiment flip
  {
    ...
    desc: "Dashboard de NPS tá mostrando 90% negativo, mas as reviews na home são tipo 'amei o produto, 5 estrelas, recomendo'. Time de produto querendo entender.",
    ...
    logs: [
      { ts: "14:11:08", lv: "INF", msg: "comprehend.DetectSentiment · text='Amei o produto, recomendo!'" },
      { ts: "14:11:08", lv: "INF", msg: "response: Sentiment=NEGATIVE Score.Negative=0.78" },
      { ts: "14:11:09", lv: "INF", msg: "comprehend.DetectSentiment · text='Pior compra da minha vida'" },
      { ts: "14:11:09", lv: "INF", msg: "response: Sentiment=POSITIVE Score.Positive=0.61" },
      { ts: "14:11:12", lv: "WRN", msg: "request param: LanguageCode='en'" },
      { ts: "14:11:13", lv: "INF", msg: "input text language (detected): pt" },
    ],
    actions: [
  ...
  // SEV-3: Polly mispronunciation
  {
    ...
    desc: "Cliente reclama que audiolivros sobre tech ficaram engraçados: Polly lê 'Kubernetes' como 'cubernetes', 'PyTorch' como 'pee-torch'. Editor desistiu de revisar manualmente.",
    ...
    logs: [
      { ts: "08:21:14", lv: "INF", msg: "polly.SynthesizeSpeech · VoiceId=Camila · text=length 4127" },
      { ts: "08:21:14", lv: "INF", msg: "input contains: Kubernetes, Docker, PyTorch, GraphQL" },
      { ts: "08:21:15", lv: "INF", msg: "LexiconNames=[] · no lexicons attached to request" },
      { ts: "08:21:15", lv: "INF", msg: "TextType=text (no SSML)" },
      { ts: "08:21:16", lv: "WRN", msg: "lexicon 'tech-terms-en-words' exists in account · last_used=never" },
    ],
    actions: [
  ...
  // SEV-2: Personalize cold start
  {
    ...
    desc: "Sistema de recomendação tá entregando os mesmos 3 produtos pra todo usuário novo. Engagement caiu 40% em 2 semanas. Time de growth puxou o cabo do servidor por engano? não, é Personalize mesmo.",
    ...
    logs: [
      { ts: "11:42:33", lv: "INF", msg: "personalize.GetRecommendations · userId=u-new-882471 · numResults=10" },
      { ts: "11:42:33", lv: "INF", msg: "response: [item_881, item_42, item_1207, item_881, item_42, item_1207, ...]" },
      { ts: "11:42:34", lv: "INF", msg: "personalize.GetRecommendations · userId=u-new-882472" },
      { ts: "11:42:34", lv: "INF", msg: "response: [item_881, item_42, item_1207, item_881, item_42, item_1207, ...]" },
      { ts: "11:42:35", lv: "WRN", msg: "recipe in use: aws-hrnn · no cold-start strategy" },
      { ts: "11:42:36", lv: "INF", msg: "user u-new-882471 interactions in dataset: 0" },
    ],
    actions: [
  ...
  // SEV-2: Lex too few utterances
  {
    ...
    slack: "#war-room-bot",
    desc: "Bot de atendimento tá caindo no FallbackIntent em 61% das mensagens. Suporte humano voltou pra carga total, tickets explodiram. Time montou o bot, lançou, e foi viajar.",
    ...
    logs: [
      { ts: "15:18:22", lv: "INF", msg: "lex.RecognizeText · botAlias=prod · input='meu sinal sumiu'" },
      { ts: "15:18:22", lv: "INF", msg: "matched: FallbackIntent · confidence=null" },
      { ts: "15:18:25", lv: "INF", msg: "lex.RecognizeText · input='tô com problema na internet'" },
      { ts: "15:18:25", lv: "INF", msg: "matched: FallbackIntent · confidence=null" },
      { ts: "15:18:27", lv: "WRN", msg: "intent OpenTicket configured utterances: 2" },
      { ts: "15:18:27", lv: "INF", msg: "best alternative intent score: 0.31 (below threshold 0.40)" },
    ],
    actions: [
  ...
  // SEV-1: Rekognition trigger-happy
  {
    ...
    desc: "Após update, Rekognition tá flagging 80% das fotos como inadequadas — incluindo paisagens, comida, fotos de bebê. Suporte explodiu, app store reviews em queda livre.",
    ...
    logs: [
      { ts: "09:15:42", lv: "INF", msg: "rekognition.DetectModerationLabels · image=beach-sunset.jpg" },
      { ts: "09:15:42", lv: "INF", msg: "labels=[{Name:'Suggestive', Confidence:34.2}] · IMAGE_BLOCKED" },
      { ts: "09:15:43", lv: "INF", msg: "rekognition.DetectModerationLabels · image=baby-photo.jpg" },
      { ts: "09:15:43", lv: "INF", msg: "labels=[{Name:'Suggestive', Confidence:32.9}] · IMAGE_BLOCKED" },
      { ts: "09:15:45", lv: "INF", msg: "rekognition.DetectModerationLabels · image=family-bbq.jpg" },
      { ts: "09:15:45", lv: "INF", msg: "labels=[{Name:'Alcohol', Confidence:41.7}] · IMAGE_BLOCKED" },
      { ts: "09:15:46", lv: "WRN", msg: "current config: MinConfidence=30 · was 80 yesterday" },
    ],
    actions: [
  ...
  // SEV-1: Classification metrics — accuracy vs precision/recall/F1
  {
    ...
    desc: "Data Scientist defende o modelo: '99.4% de acurácia, tá ótimo!'. Risk officer: 'então por que perdemos $2.1M em fraudes esse mês?'. CEO marcou call pras 14h.",
    ...
    logs: [
      { ts: "13:02:11", lv: "INF", msg: "sagemaker.invoke_endpoint · fraud-detector-v3" },
      { ts: "13:02:11", lv: "INF", msg: "input: transaction_id=tx-8821 amount=R$12,400" },
      { ts: "13:02:11", lv: "INF", msg: "prediction: legit · confidence: 0.96" },
      { ts: "13:02:11", lv: "INF", msg: "actual outcome (chargeback in 7d): <b>fraud</b>" },
      { ts: "13:02:14", lv: "INF", msg: "model.training.eval_metric: <b>accuracy</b>" },
      { ts: "13:02:15", lv: "WRN", msg: "dataset class balance: 99.0% legit · 1.0% fraud" },
    ],
    actions: [
  ...
  // SEV-2: Inference types — real-time vs async vs serverless vs batch
  {
    ...
    slack: "#war-room-cfo",
    desc: "CFO da ScanX olhou a fatura do mês: $14k em UM endpoint SageMaker. Modelo é pequeno, médicos têm SLA de 5min pra resultado, mas o endpoint fica ligado 24/7. Cortar 60% do custo ou cortar o projeto.",
    ...
    logs: [
      { ts: "01:14:08", lv: "INF", msg: "endpoint xray-classifier-prod · status: InService · idle for 23m" },
      { ts: "01:14:08", lv: "INF", msg: "instance billing: ml.g4dn.xlarge × 2 · $1.47/hr · 24/7" },
      { ts: "10:00:12", lv: "INF", msg: "invocations spike · 480 req/min · gpu_util=68%" },
      { ts: "20:00:01", lv: "INF", msg: "invocations: 3 req/min · gpu_util=2%" },
      { ts: "20:00:02", lv: "INF", msg: "model size on disk: 487 MB · supports serverless" },
    ],
    actions: [
  ...
  // SEV-3: Regression metrics — MAE vs MSE vs RMSE vs R²
  {
    ...
    desc: "PrintShop errou Black Friday DE NOVO. Estoque vazio, $400k em vendas perdidas. Modelo de previsão de demanda foi validado com MAE=12, mas RMSE=89 e R²=0.42. Time de supply: 'os números parecem bons, mas a vida real fica caótica em datas sazonais'.",
    ...
    logs: [
      { ts: "24/11 04:12", lv: "INF", msg: "demand-forecast prediction · sku=ink-cartridge-bf · predicted: 240" },
      { ts: "24/11 23:59", lv: "ERR", msg: "actual demand: <b>1,890</b> · stockout at 08:14" },
      { ts: "25/11 09:00", lv: "WRN", msg: "model evaluation · metric: MAE=12 · validation set excluded Black Friday weeks" },
      { ts: "25/11 09:00", lv: "INF", msg: "algorithm: LinearLearner · predictor_type: regressor" },
      { ts: "25/11 09:02", lv: "WRN", msg: "R²=0.42 below 0.7 production threshold (warning ignored)" },
    ],
    actions: [
  ...
  // SEV-2: Algorithm choice — regression vs classification
  {
    ...
    customer: "ChurnTech",
    slack: "#war-room-ml",
    desc: "Time de produto recebeu o output do novo modelo de churn: 'probabilidade −0.18, 1.32, 0.42, −0.31...'. Question: 'como apresento −0.18 de chance de churn pro CEO?'. DS júnior escolheu Regressão Linear em vez de um algoritmo de classificação.",
    ...
    logs: [
      { ts: "11:42:00", lv: "INF", msg: "endpoint invocation · model=ChurnModel-v1" },
      { ts: "11:42:00", lv: "INF", msg: "input shape: (1, 47) · features: usage, plan, support_tickets..." },
      { ts: "11:42:00", lv: "INF", msg: "output: <b>−0.182</b> · user_id=u-12498" },
      { ts: "11:42:01", lv: "INF", msg: "output: <b>1.412</b> · user_id=u-12502" },
      { ts: "11:42:02", lv: "WRN", msg: "algoritmo configurado: <b>Linear Regression</b> · modo regressão" },
      { ts: "11:42:02", lv: "WRN", msg: "saída do modelo: real (qualquer número), não probabilidade" },
    ],
    actions: [
  ...
  // SEV-2: Trainium vs P4d — specialized chips
  {
    ...
    desc: "GenLab tá fazendo fine-tuning de um LLM em ml.p4d.24xlarge. Cada run leva 72h, custa $9.5k. CFO viu $85k de SageMaker training no mês e pediu corte de 40%. Time tá usando o setup padrão de GPU.",
    ...
    logs: [
      { ts: "07:14:08", lv: "INF", msg: "sagemaker.create_training_job · llm-finetune-v2" },
      { ts: "07:14:08", lv: "INF", msg: "instance_type=ml.p4d.24xlarge · count=4" },
      { ts: "07:14:08", lv: "INF", msg: "framework=pytorch · distribution=ddp" },
      { ts: "07:14:09", lv: "INF", msg: "estimated cost: $131.08/hr × 72h = $9,438" },
      { ts: "07:14:10", lv: "INF", msg: "training script: huggingface transformers + torch.distributed" },
      { ts: "07:14:11", lv: "WRN", msg: "no spot, no savings plan, no specialized chip evaluation in job tag" },
    ],
    actions: [
